...
def assessment_agent(emp_id: int):
    ...
    try:
        with conn.cursor() as cursor:
            ...
            # Fetch recent assessment results (last 5) with proper formatting
            cursor.execute("""
                SELECT course_name, marks_obtained, attempt_date 
            ...
            # Debug: Print the assessment data to console
            print(f"DEBUG: Assessment data for emp_id {emp_id}:")
            for assessment in recent_assessments:
                print(f"  Course: {assessment['course_name']}, Marks: {assessment['marks_obtained']}, Date: {assessment['attempt_date']}")
        ...
        print(f"ERROR in assessment_agent: {e}")
